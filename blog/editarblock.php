...
if(empty($_GET['editar'])){
    ...
    $block_id = $_GET['editar'];
    $categoria_nombre = $_GET['nombre'];
    $fecha_creacion = $_GET['nombre'];
    $titulo = $_GET['nombre'];
...
<body style="background: linear-gradient(to right,#5695EC ,#3BEEAF);">
    ...
    <div class="col-12 text-center">
        <a class="blog-header-logo text-dark" href="../blog/index.php"><h1>blog</h1></a>
      </div>
        <div class="row" style="justify-content: center;">
            <div class="col-sm-6 col-md-6" style="margin-top: 5%;">
                <form class="shadow-lg bg-white mb-5" style="padding: 20px; border-radius:20px;"
                    action="../databases/editarBlock.php" method="POST">
                       <h2 class="text-center mb-2">Editar blog</h2>
                      
                    <div class="mb-3">
                        <input type="hidden" name="id" id="id" value="<?php echo $blog_id; ?>">
